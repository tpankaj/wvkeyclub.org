...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
  <head>
    <title>2013-2014 Hours List -  Westview Key Club</title>
	...
	<div class="small-12 columns">
	  <table id="hourslist" class="tablesorter" style="margin-left:auto; margin-right:auto;">
	    ...
	    <tbody>
		 ...
		 ?>
	      <tr>
		<td><a href="/hours/2013-2014/viewdetailedhours.php?id=<?php echo $member["_id"]; ?>"><?php echo $member["lname"]; ?>, <?php echo $member["fname"]; ?></a></td>
		<td>
		  <?php
